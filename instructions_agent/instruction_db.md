...
## 🎯 Obiettivo
Creare e popolare il database **SQLite (`instance/ochem.sqlite3`)** per il progetto **OCHEM**, seguendo lo schema approvato.

**Lo script deve:**
1. Inizializzare il DB tramite **Alembic**
...
| Cicli          | cycle, cycle_parameter            | definizione dei cicli e parametri        |
